...
const ahsDatabase = [
  ...
  // ==================== PEKERJAAN LANDSCAPE (SEMUA TERKUNCI) ====================
  {
    code: "AHS-LSC-01",
  ...
  // ==================== PEKERJAAN JALAN & JEMBATAN (SEMUA TERKUNCI) ====================
  {
    code: "AHS-JLN-01",
  ...
  // ==================== PEKERJAAN JALAN & JEMBATAN (LANJUTAN) ====================
  {
    code: "AHS-JLN-02",
    category: "Pekerjaan Jalan dan Jembatan",
  ...
  // ==================== PEKERJAAN MEKANIKAL & ELEKTRIKAL (LANJUTAN) ====================
  {
    code: "AHS-MEP-09",
