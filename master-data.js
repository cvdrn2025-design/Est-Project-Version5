...
// ============================================================
// MAPPING KATEGORI KE SINGKATAN (LENGKAP + LANDSCAPE)
// ============================================================
...
// Mapping terbalik (dari singkatan ke kategori)
...
// Fungsi untuk cek apakah kategori baru
...
// Fungsi untuk mendapatkan kategori dari singkatan
...
// Fungsi untuk mendapatkan kategori dari kode unik
function getCategoryFromCode(code) {
  ...
  // Cek di ahsDatabase berdasarkan code langsung
  if (typeof ahsDatabase !== 'undefined' && Array.isArray(ahsDatabase)) {
    const itemByCode = ahsDatabase.find(i => i.code === code || i.kode === code);
    if (itemByCode) return itemByCode.category || 'Lainnya';
  }
  
  return null;
}

// Fungsi untuk mendapatkan info pembayaran
